...
from models import ErnieForQuestionAnswering,BertForQuestionAnswering,RobertaForQuestionAnswering, AlbertForQuestionAnswering
from paddlenlp.transformers import BertTokenizer, ErnieTokenizer, RobertaTokenizer, AlbertTokenizer
