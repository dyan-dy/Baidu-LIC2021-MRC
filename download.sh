...
echo "Download DuReader-checklist test1"
wget --no-check-certificate https://dataset-bj.cdn.bcebos.com/lic2021/dureader_checklist.test1.tar.gz
tar -zxvf dureader_checklist.test1.tar.gz
rm dureader_checklist.test1.tar.gz

echo "Download DuReader-checklist test2"
wget --no-check-certificate https://dataset-bj.cdn.bcebos.com/lic2021/dureader_checklist.test2.tar.gz
tar -zxvf dureader_checklist.test2.tar.gz
rm dureader_checklist.test2.tar.gz
