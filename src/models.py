from paddlenlp.transformers import ErniePretrainedModel, BertPretrainedModel, RobertaPretrainedModel, AlbertPretrainedModel
...
class AlbertForQuestionAnswering(AlbertPretrainedModel):
    def __init__(self, albert):
        ...
        self.albert = albert  # allow albert to be config
        self.classifier = nn.Linear(self.albert.config["hidden_size"], 2)
        self.classifier_cls = nn.Linear(self.albert.config["hidden_size"], 2)
        self.apply(self.init_weights)
